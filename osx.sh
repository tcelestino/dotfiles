...
# based on paul irish osx.sh (https://github.com/paulirish/dotfiles/blob/master/.osx)
...
# Disable the you sure you want to open this application dialog
